<?php
	...
	if (isset($_POST['submit'])) {
		...
		$insertmenu = mysqli_query($con, "INSERT INTO menu (restaurant_idd, restaurant, food_category, food, price, food_image) VALUES ('{$restid}','{$eachrestaurant}','{$category}', '{$food}', '{$price}', '{$food_image}')");
		if($insertmenu){
